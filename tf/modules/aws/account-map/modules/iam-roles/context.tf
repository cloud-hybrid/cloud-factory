...
module "this" {
  ...
  descriptor-formats  = var.descriptor-formats
  labels-as-tags      = var.labels-as-tags
...
variable "context" {
  ...
  default = {
    ...
    # but we want the default to be all the labels in `label-order`
    # and we want users to be able to prevent all tag generation
    # by setting `labels-as-tags` to `[]`, so we need
    # a different sentinel to indicate "default"
    labels-as-tags = ["unset"]
  }
  description = <<-EOT
...
variable "labels-as-tags" {
  ...
  description = <<-EOT
    ...
    **Notes:**
      ...
      Unlike other `null-label` inputs, the initial setting of `labels-as-tags` cannot be
